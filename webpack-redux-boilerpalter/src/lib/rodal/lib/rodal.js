...
var Rodal = function (_Component) {
    ...
    _createClass(Rodal, [{
        ...
        value: function render() {
            var mask = this.props.showMask ? _react2.default.createElement('div', { className: 'rodal-mask', style: this.props.customMaskStyles, onClick: (this.props.isMaskClose ? this.props.onClose : null)}) : null;
            var style = {
